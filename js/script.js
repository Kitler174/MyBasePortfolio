...
document.addEventListener("DOMContentLoaded", function () {
    const yaakElement = document.getElementById("YAAK-entrance");
    const wall = document.getElementById("wall");

    yaakElement.addEventListener("animationend", function () {
        yaakElement.src="./images/yaakpower.png"
        yaakElement.style.animation = "secondAnimation 0.4s ease-in-out";
        wall.style.animation = "wall 1s ease-in-out";
    });

    wall.addEventListener("animationend", function () {
        yaakElement.src="./images/YAAK.png"
        wall.src="./images/best_hero.png"
        wall.style.animation = "king_back 4s ease-in-out";
    })
